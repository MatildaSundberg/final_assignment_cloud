...
to the Gatekeeper instance with the endpoint /custom . The script inserts unique records into the `actor` table (write operation) 
...
# Configuration
URL = f"http://{gatekeeper_public_ip}:5000/custom"  # Replace with actual Gatekeeper URL
AUTH_KEY = "safe-key"  # Authorization key for requests
HEADERS = {"Content-Type": "application/json"}

# Log file paths
WRITE_LOG_FILE = "test_results/write_results_custom.log"
READ_LOG_FILE = "test_results/read_results_custom.log"
